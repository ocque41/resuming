...
const generateOptimizedDocument = async (content: string, name: string = 'CV', contactInfo?: StructuredCV['contactInfo'], structuredCV?: StructuredCV): Promise<Document> => {
  ...
  if (!structuredCV) {
    ...
    const sectionOrder = ['PROFILE', 'SUMMARY', 'ACHIEVEMENTS', 'CAREER GOALS', 'GOALS', 'LANGUAGES', 'SKILLS', 'TECHNICAL SKILLS', 'PROFESSIONAL SKILLS', 'EDUCATION', 'EXPERIENCE', 'REFERENCES'];
