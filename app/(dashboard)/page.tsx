...
import { FileText, TrendingUp, Shield, Star, Zap, ArrowRight, Check } from "lucide-react";
...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col bg-[#050505]">
      {/* Navbar */}
      <nav
        className={`flex items-center justify-between p-4 sticky top-0 z-50 transition-all duration-300 ${
      ...
      >
        ...
        <div className="hidden md:flex items-center space-x-4">
          <Link href="/dashboard/pricing" className="text-white">
            Product
          </Link>
          <Link href="https://chromad.vercel.app/docs/products/resuming/overview" className="text-white">
            Documentation
          </Link>
          <Link
              ...
              <MenuItem>
                {({ active }) => (
                  <Link
                    ...
                    className={`${active ? "bg-gray-700" : ""} block px-4 py-2`}
                  >
                    Product
                  </Link>
                )}
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-4 bg-[#050505] text-center">
        ...
        <div className="flex justify-center space-x-4 mb-8">
          ...
          <Button asChild variant="outline" size="lg" className="border border-blue-600 text-blue-600 px-6 py-3 rounded-md hover:bg-blue-600 hover:text-white transition">
      ...
      <section className="min-h-[100dvh] flex items-center justify-center px-4 relative">
        <motion.div className="w-full max-w-7xl mx-auto py-16" variants={containerVariants} initial="hidden" animate="visible">
        ...
        <motion.div className="max-w-7xl mx-auto space-y-16" variants={containerVariants} initial="hidden" animate="visible">
          <motion.section className="grid md:grid-cols-3 gap-8" variants={containerVariants}>
            {[
              ...
              <motion.div key={title} className={`${bgColor} p-6 rounded-lg shadow-md hover:shadow-xl transition-all duration-base ease-default group border border-gray-800 hover:border-gray-700`} variants={itemVariants}>
