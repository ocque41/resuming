  ...
  return (
    <div className="flex flex-col min-h-[calc(100dvh-68px)] max-w-7xl mx-auto w-full bg-black bg-gradient-to-br from-black via-[#0a0a0a] to-[#1a1a1a] text-white">
      ...
      <div className="flex flex-1 overflow-hidden h-full">
        {/* Sidebar */}
        <aside
          className={`w-64 bg-[#2C2420] border-r border-[#584235] lg:block ${
            ...
            {navItems.map((item) => (
              <Link key={item.href} href={item.href} passHref>
                <Button
                  ...
                  className={`shadow-none my-1 w-full justify-start text-[#B4916C] hover:text-white hover:bg-[#584235] ${
                    pathname === item.href ? 'bg-[#584235] text-white' : ''
                  }`}
