...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        'safiro': ['var(--font-safiro)', 'sans-serif'],
      ...
      keyframes: {
        ...
        glow: {
          '0%': { boxShadow: '0 0 5px rgba(180, 145, 108, 0.4)' },
          '100%': { boxShadow: '0 0 20px rgba(180, 145, 108, 0.7)' },
        },
        bounceSubtle: {
      ...
      animation: {
        ...
        'slide-in-up': 'slideInUp 0.4s cubic-bezier(0.22, 1, 0.36, 1) forwards',
        'slide-in-down': 'slideInDown 0.4s cubic-bezier(0.22, 1, 0.36, 1) forwards',
