    ...
    <div className="w-full">
      ...
      <Combobox value={selected} onChange={handleChange}>
        ...
        <div className="relative mt-1">
          <div className={`relative w-full cursor-default overflow-hidden rounded-lg text-left shadow-sm border accent-border accent-shadow focus-within:ring-1 ${darkMode ? 'bg-[#050505]' : 'bg-white'}`}>
            <Combobox.Input
              className={`w-full border-none py-2.5 pl-3 pr-10 leading-5 focus:ring-0 ${darkMode ? 'bg-[#050505] text-gray-200 placeholder-gray-500' : 'bg-white text-gray-900 placeholder-gray-400'}`}
          ...
          >
            <Combobox.Options
              className={`absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md py-1 text-base shadow-lg
                         ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm ${darkMode ? 'bg-[#050505]' : 'bg-white'}`}
            >
