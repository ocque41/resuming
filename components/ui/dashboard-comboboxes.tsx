...
export function ComboboxPopover({ label, options, onSelect }: ComboboxPopoverProps) {
  ...
  // When a new option is selected, update state and call onSelect.
        ...
        <div className="relative mt-1">
          ...
          >
            {filteredOptions.length > 0 ? (
              ...
              <div className="absolute mt-1 w-full bg-white shadow-lg rounded-md py-2 px-3 text-sm text-gray-700">
                Nothing found.
              </div>
            ) : null}
          </Transition>
