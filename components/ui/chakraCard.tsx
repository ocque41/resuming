import * as React from "react"
 ...
 >(({ className, ...props }, ref) => (
   <div
     ref={ref}
     className={cn(
       "rounded-lg border border-[#584235] bg-[#2C2420] text-card-foreground shadow-sm",
       className
     )}
     {...props}
   />
 ...
 >(({ className, ...props }, ref) => (
   <h3
     ref={ref}
     className={cn(
       "text-2xl font-semibold leading-none tracking-tight text-[#E8DCC4]",
       className
     )}
     {...props}
   />
 ...
 >(({ className, ...props }, ref) => (
   <p
     ref={ref}
     className={cn("text-sm text-[#B4916C]", className)}
     {...props}
   />
 ))
