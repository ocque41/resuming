...
export function standardizeCV(originalText: string, analysis: any = null): Record<string, string> {
  ...
  if (originalSections.education || originalSections.academic_background) {
    ...
    standardizedSections["EDUCATION"] = formatStandardizedEducation(educationSection);
  }
  ...
  if (originalSections.languages || originalSections.language_skills) {
    ...
    standardizedSections["LANGUAGES"] = formatStandardizedLanguages(languagesSection);
  }
 ...
 */
function formatStandardizedLanguages(languagesText: string): string {
  // Extract languages
